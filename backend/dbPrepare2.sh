...
curl --request POST --url http://52.74.109.132:5000/api/roles --header 'content-type: application/json' \
  --data '{
	"rolename": "admin"
}'
curl --request POST --url http://52.74.109.132:5000/api/roles --header 'content-type: application/json' \
...
curl --request POST --url http://52.74.109.132:5000/api/users --header 'content-type: application/json' \
  --data '{
	"userId": "admin",
...
curl --request POST --url http://52.74.109.132:5000/api/categories --header 'content-type: application/json' \
  --data '{
	"name": "Bánh Kẹo",
  "active": true
}'
...
curl --request POST --url http://52.74.109.132:5000/api/countries --header 'content-type: application/json' \
  --data '{
	"name": "Việt Nam",
  "code":"vn"
}'
...
curl --request POST --url http://52.74.109.132:5000/api/brands --header 'content-type: application/json' \
  --data '{
	"name": "Đài Loan",
  "countryId":"3",
  "active":true
...
curl --request POST --url http://52.74.109.132:5000/api/products --header 'content-type: application/json' \
  --data '{
    ...
    "stockNum": 100,
    "active":true,
    "imgThump":"images/products/BanhKeo/p1_1.jpg",
    "img1":"images/products/BanhKeo/p1_1.jpg",
    "firstCategoryId":10,
    "secondCategoryId":1,
    "brandId":1
}'
curl --request POST --url http://52.74.109.132:5000/api/products --header 'content-type: application/json' \
  --data '{
	  "name": "Bánh xốp Fullo Vani Sữa (Fullo Stick Wafer Vanilla Milk) Trang",
    "descShort":"Bánh xốp Fullo Vani Sữa (Fullo Stick Wafer Vanilla Milk) desc Short",
    "descMedium":"Bánh xốp Fullo Vani Sữa (Fullo Stick Wafer Vanilla Milk) desc Medium",
    "descLong":"Bánh xốp Fullo Vani Sữa (Fullo Stick Wafer Vanilla Milk) desc Long",
    "unitPrice":10000,
    "stockNum": 1000,
    "active":true,
    "imgThump":"images/products/BanhKeo/p2_1.jpg",
...
curl --request POST --url http://52.74.109.132:5000/api/products --header 'content-type: application/json' \
  --data '{
    ...
    "stockNum": 100,
    "active":true,
    "imgThump":"images/products/BanhKeo/p3_1.jpg",
    "img1":"images/products/BanhKeo/p3_1.jpg",
    "img2":"images/products/BanhKeo/p3_2.jpg",
    "img3":"images/products/BanhKeo/p3_3.jpg",
    "img4":"images/products/BanhKeo/p3_4.jpg",
    "img5":"images/products/BanhKeo/p3_5.jpg",
    "img6":"images/products/BanhKeo/p3_6.jpg",
    "firstCategoryId":11,
    "secondCategoryId":1,
    "brandId":3
}'
...
curl --request POST --url http://52.74.109.132:5000/api/products --header 'content-type: application/json' \
  --data '{
    ...
    "stockNum": 100,
    "active":true,
    "imgThump":"images/products/ThucPham/ptp_1_1.jpg",
    "img1":"images/products/ThucPham/ptp_1_1.jpg",
    "img2":"images/products/ThucPham/ptp_1_2.jpg",
    "firstCategoryId":16,
    "secondCategoryId":2,
    "brandId":4
}'
...
curl --request POST --url http://52.74.109.132:5000/api/products --header 'content-type: application/json' \
  --data '{
    ...
    "stockNum": 100,
    "active":true,
    "imgThump":"images/products/ThucPham/ptp_2_1.jpg",
    "img1":"images/products/ThucPham/ptp_2_1.jpg",
    "firstCategoryId":16,
    "secondCategoryId":2,
    "brandId":4
}'
...
curl --request POST --url http://52.74.109.132:5000/api/products --header 'content-type: application/json' \
  --data '{
    ...
    "stockNum": 1000,
    "active":true,
    "imgThump":"images/products/DoUong/pdu_1_1.jpg",
    "img1":"images/products/DoUong/pdu_1_1.jpg",
    "firstCategoryId":17,
    "secondCategoryId":3,
    "brandId":5
}'
...
curl --request POST --url http://52.74.109.132:5000/api/attributegroups --header 'content-type: application/json' \
  --data '{
	"name": "Màu Sắc"
}'
curl --request POST --url http://52.74.109.132:5000/api/attributegroups --header 'content-type: application/json' \
...
# --------------------------Insert Attribute -------------------------------
curl --request POST --url http://52.74.109.132:5000/api/attributes --header 'content-type: application/json' \
  --data '{
	"name": "Xanh",
  "attributeGroupId":1
}'
...
curl --request POST --url http://52.74.109.132:5000/api/productattributes --header 'content-type: application/json' \
  --data '{
	"productId": 1,
  "attributeId":3
}'
...
curl --request POST --url http://52.74.109.132:5000/api/discounts --header 'content-type: application/json' \
  --data '{
	"desc": "Category Banh Mem giam gia 30% trong thang 9",
    "from":"2019-10-01 23:42:06",
